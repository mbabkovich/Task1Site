...
/*!*****************************!*\
  !*** ./src/newsChannels.js ***!
  \*****************************/
/*! exports provided: NewsChannels */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"NewsChannels\", function() { return NewsChannels; });\n/* harmony import */ var _news__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./news */ \"./src/news.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar NewsChannels =\n/*#__PURE__*/\nfunction () {\n  function NewsChannels() {\n    _classCallCheck(this, NewsChannels);\n\n    this._newsChannelsContainer = document.getElementById(\"newsChannelsContainer\");\n    this._news = new _news__WEBPACK_IMPORTED_MODULE_0__[\"News\"]();\n  }\n\n  _createClass(NewsChannels, [{\n    key: \"addNewChannel\",\n    value: function addNewChannel(source) {\n      var option = document.createElement(\"Option\");\n      option.value = source.id;\n      option.text = source.name;\n\n      this._newsChannelsList.add(option);\n    }\n  }, {\n    key: \"fillNewsChannels\",\n    value: function fillNewsChannels(sources) {\n      var _this = this;\n\n      if (this._newsChannelsList) {\n        this._newsChannelsContainer.removeChild(this._newsChannelsList);\n      }\n\n      this._newsChannelsList = document.createElement(\"Select\");\n      this._newsChannelsList.id = \"newsChannelsSelect\";\n      this._newsChannelsList.size = 20;\n\n      this._newsChannelsList.onchange = function () {\n        return _this._news.requestNews(_this._newsChannelsList.value);\n      };\n\n      this._newsChannelsContainer.appendChild(this._newsChannelsList);\n\n      sources.forEach(function (source) {\n        return _this.addNewChannel(source);\n      });\n    }\n  }, {\n    key: \"requestNewsChannels\",\n    value: function () {\n      var _requestNewsChannels = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee() {\n        var newsSourcesUrl, response, data;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                newsSourcesUrl = 'https://newsapi.org/v2/sources?apiKey=cf033c57da2e4126b52df66a8cdd2f89';\n                _context.next = 3;\n                return fetch(newsSourcesUrl);\n\n              case 3:\n                response = _context.sent;\n                _context.next = 6;\n                return response.json();\n\n              case 6:\n                data = _context.sent;\n                this.fillNewsChannels(data.sources);\n\n              case 8:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      return function requestNewsChannels() {\n        return _requestNewsChannels.apply(this, arguments);\n      };\n    }()\n  }]);\n\n  return NewsChannels;\n}();\n\n//# sourceURL=webpack:///./src/newsChannels.js?");

/***/ }),

/***/ "C:\\Users\\Mikhail_Babkovich\\AppData\\Roaming\\npm\\node_modules\\webpack\\buildin\\global.js":
/*!***********************************!*\
